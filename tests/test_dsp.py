import pytest
from pyfmodex.enums import DSPCONNECTION_TYPE, SPEAKERMODE, DSP_PARAMETER_DATA_TYPE, DSP_ECHO, DSP_COMPRESSOR, DSP_OSCILLATOR, DSP_PARAMETER_TYPE, DSP_TYPE, RESULT
