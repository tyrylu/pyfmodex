...
setup(name="pyfmodex", version="0.3.1", author="Lukas Tyrychtr", author_email="lukastyrychtr@gmail.com", url="https://www.github.com/tyrylu/pyfmodex", packages=["pyfmodex"], long_description=open("readme.md", "r").read(), description="Python bindings to the Fmod Ex library.", license="MIT", classifiers=clfs)