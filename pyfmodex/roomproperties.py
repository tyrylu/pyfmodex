...
class RoomProperties(Structure):
    _fields_ = [
        ...
        ("material_names", c_int * 6), #{MaterialName::kTransparent, MaterialName::kTransparent,MaterialName::kTransparent, MaterialName::kTransparent,MaterialName::kTransparent, MaterialName::kTransparent},
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.material_names = (c_int * 6)(MaterialNames.kTransparent.value, MaterialNames.kTransparent.value, MaterialNames.kTransparent.value, MaterialNames.kTransparent.value, MaterialNames.kTransparent.value, MaterialNames.kTransparent.value)
