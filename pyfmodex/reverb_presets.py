...
class FMOD_REVERB_PRESET(Enum):
    ...
    FMOD_PRESET_CARPETTEDHALLWAY                = (   300,    2,  30, 5000,  10, 100, 100, 250, 0,   500,  56, -24.0 )
    FMOD_PRESET_HALLWAY                         = (  1500,    7,  11, 5000,  59, 100, 100, 250, 0,  7800,  87,  -5.5 )
    FMOD_PRESET_STONECORRIDOR                   = (   270,   13,  20, 5000,  79, 100, 100, 250, 0,  9000,  86,  -6.0 )
    ...
    FMOD_PRESET_PARKINGLOT                      = (  1700,    8,  12, 5000, 100, 100, 100, 250, 0, 20000,  56, -19.5 )
